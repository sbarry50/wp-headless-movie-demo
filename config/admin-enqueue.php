...
return [
    ...
    ********************************************************/
    ...
    'stylesheets' => [
        [
            'id'       => 'settings-admin',
            'src'          => SB2Media\MovieDemo\url('dist/css/settings-admin.css'),
            'dependencies' => [],
            'version'      => false,
            'media'       => 'all',
        ],
    ...
    ********************************************************/
    'scripts' => [
        ...
        [
            'id'           => 'input-mask',
            'src'          => SB2Media\MovieDemo\url('dist/js/input-mask.js'),
            'dependencies' => [],
            'version'      => false,
            'in_footer'    => true,
        ],
        [
            'id'           => 'media-uploader',
            'src'          => SB2Media\MovieDemo\url('dist/js/media-uploader.js'),
            'dependencies' => [],
            'version'      => false,
            'in_footer'    => true,
            'media'        => true,
